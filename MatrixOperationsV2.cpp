    ...
    for(int p=0; p<powtorzenia; p++)
    {
        ...
        for(int w=0; w<(instrukcje.length()-1); w++)
        {
            ...
            case 'T':{									//*
                ...
                case 'T': instrukcje[0]= instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
                case '!': break;
                }} break;
            ...
            case 'D':{									//&
                ...
                case 'D': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
                case '!': break;
                }} break;
            case 'H':{ 									//&
                switch(instrukcje[w+1]){
                ...
                case 'H': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!';
                case '!': break;
                }} break;
            case 'V':{ 									//*
                switch(instrukcje[w+1]){
                ...
                case 'V': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
                case '!': break;
                }}   break;
            case 'A':{									//
                switch(instrukcje[w+1]){
                ...
                case 'C': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
                case 'X': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
            ...
            case 'B':{									//
                ...
                case 'B': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
                case 'Y': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
            ...
            case 'C':									//*
                ...
                case 'A': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
                case 'B': instrukcje[0]='A'; break;
                case 'Y': instrukcje[0]='A'; break;
                case 'C': instrukcje[0]='B'; break;
                case 'X': instrukcje[0]='B'; break;
                case 'Z': instrukcje[0]= instrukcje[w+2]; instrukcje[w]='!'; instrukcje[w+2]='!'; break;
                case '!': break;
                } break;
            case 'X':{									//
                switch(instrukcje[w+1]){
